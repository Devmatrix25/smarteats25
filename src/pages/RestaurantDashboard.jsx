...
import RestaurantDashboardStats from "@/components/restaurant/RestaurantDashboardStats";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <RestaurantDashboardStats
          stats={{
            ...
            averageRating: restaurant.average_rating || 4.5,
            activeCustomers: completedToday.length * 10,
            revenueChange: 12.5,
            ordersChange: 8.3,
            ratingChange: 2.1,
            customersChange: 5.2
